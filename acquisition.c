...
void affiche_acquisition_achat_aff(joueur *j,acquisition *acqui){
  ...
  MLV_draw_adapted_text_box(50,50,acqui->titre,9,MLV_COLOR_RED,MLV_COLOR_BLACK,MLV_COLOR_WHITE,MLV_TEXT_LEFT,MLV_HORIZONTAL_CENTER,MLV_VERTICAL_CENTER);/*,acqui.titre,acqui.achat,acqui.vente,acqui.commission,9,MLV_COLOR_RED,MLV_COLOR_WHITE,MLV_COLOR_BLACK);*/
  MLV_draw_text_box(90,190,30,20,"OUI",9,MLV_COLOR_RED,MLV_COLOR_BLACK,MLV_COLOR_WHITE,MLV_TEXT_LEFT,MLV_HORIZONTAL_CENTER,MLV_VERTICAL_CENTER);
  MLV_draw_text_box(140,190,30,20,"NON",9,MLV_COLOR_RED,MLV_COLOR_BLACK,MLV_COLOR_WHITE,MLV_TEXT_LEFT,MLV_HORIZONTAL_CENTER,MLV_VERTICAL_CENTER);
...
int affiche_acquisition_vente_aff(joueur *j,acquisition *acqui){
 int x,y,choix = 1;
  ...
  MLV_clear_window(MLV_COLOR_WHITE);
  /* Dessine une boîte affichant les valeurs de l'acquisition*/ 
  MLV_draw_adapted_text_box(50,50,acqui->titre,9,MLV_COLOR_RED,MLV_COLOR_BLACK,MLV_COLOR_WHITE,MLV_TEXT_LEFT,MLV_HORIZONTAL_CENTER,MLV_VERTICAL_CENTER);
...
void vente_acquisition(joueur *j,joueur *TabJ){
  ...
  j->nb_acquisition --;
 gagnant = acquisition_commission(j, TabJ);
 TabJ[gagnant].total=TabJ[gagnant].total+ j->sesAcquisitions[i].commission;
}
